...
function nuevo(){
    opcion="c";
    document.getElementById("titulo").innerHTML="<h1> Registro de Personal Vinculacion</h1>";
...
function editar(id){
    opcion="u";
    document.getElementById("titulo").innerHTML="<h1> Edicion del Personal de Vinculacion</h1>";
    ocultarDiv("listadoGeneral");
    reset();
    var obj=new Alumnos(id,"");
    var obj2=obj.consultar();
    document.getElementById("id").value=obj2.id;
    document.getElementById("cargo").value=obj2.cargo;
